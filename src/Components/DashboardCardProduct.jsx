    ...
    <>
      <div className="flex justify-between items-center max-w-[1000px] mx-auto mt-10">
        ...
        <div className="flex items-center gap-4">
          ...
          <button disabled={cardItem.length <= 0} onClick={()=> setPurchase(true)} className="text-white bg-purple-600 px-3 py-2 rounded-full">Purchase</button>
        </div>
      </div>
      {cardItem.length <= 0 && <p className="text-center font-bold text-xl py-5">Emty Cart list</p>}
